...
from tkinter import Label, Tk, Canvas, Button, PhotoImage, Entry, Widget,ttk,Listbox,TclError
import tkinter
...
class GUI():
    ...
    def __init__(self):
        ...
        self.icon = ImageTk.PhotoImage(Image.open(
            'C:/Users/Matteo/Desktop/Lione/SOE/finalProject/Application/build/assets/logo.png'))
    ...
    def show(self):
        ...
        bg = ImageTk.PhotoImage(Image.open('build/assets/back.jpg').resize((1440, 780)))
        canvas = Canvas(
            self.window,
            height = 780,
            width = 1440,
        ...
        button_1 = Button(
            ...
            borderwidth=0,
            highlightthickness=0,
            command=lambda : self.showForm(1),
            relief="flat"
        )
        button_1.place(
            x=387.0,
        ...
        button_2 = Button(
            ...
            borderwidth=0,
            highlightthickness=0,
            command=lambda : self.showForm(2),
            relief="flat"
        )
        button_2.place(
            x=808.8817138671875,
        ...
        button_3 = Button(
            ...
            borderwidth=0,
            highlightthickness=0,
            command=lambda : self.showForm(3),
            relief="flat"
        )
        button_3.place(
            x=808.8817138671875,
        ...
        button_4 = Button(
            ...
            borderwidth=0,
            highlightthickness=0,
            command=lambda : self.showForm(4),
            relief="flat"
        )
        button_4.place(
            x=387.0,
        ...
        return
    def showForm(self,mode):
        #MODES = {1:'Air Quality', 2:'Sensor Similarity',3:'Characterising Values',4:'Location Comparison'}
        self.cleanWindow()

        bg = ImageTk.PhotoImage(Image.open('build/assets/back2.jpg').resize((1440, 780)))
        canvas = Canvas(
            self.window,
            height = 780,
            width = 1440,
        ...
        for i in range(10):
            _list[i] += f" {i+1}"
        _list = tkinter.StringVar(value=_list)
        ...
        button_5 = Button(
            ...
            borderwidth=0,
            highlightthickness=0,
            command=lambda: self.submit(entry_1,entry_2,listbox1,listbox2),
            relief="flat"
        )
        button_5.place(
    ...
    def submit(self,entry1,entry2,listbox1,listbox2):
        print(getEntry(entry1))
        print(getEntry(entry2))
        print(getList(listbox1))
        print(getList(listbox2))
